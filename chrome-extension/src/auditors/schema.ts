...
export class SchemaAuditor {
  private static readonly IMPORTANT_SCHEMAS = [
    'Organization',
    'WebPage',
    'Article',
    'BreadcrumbList',
  ...
  private static extractTypes(schema: any): string[] {
    const types: string[] = [];
  ...
  private static validateSchema(schema: any): { valid: boolean; errors: string[] } {
    const errors: string[] = [];
