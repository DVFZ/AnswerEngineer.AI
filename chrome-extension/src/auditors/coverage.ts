...
export class CoverageAuditor {
  ...
  private static checkPaginationLinks(): {
    hasNext: boolean;
    hasPrev: boolean;
    rel: boolean;
  } {
  ...
  private static analyzeInternalLinkStructure(): {
    orphaned: boolean;
    linkedFromPages: number;
  } {
  ...
  private static hasBreadcrumbMarkup(): boolean {
  ...
  private static hasMobileViewport(): boolean {
